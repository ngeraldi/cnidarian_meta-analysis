...
Script is the dirty behind the scene fixing that is necessary to any meta-analysis.
it is messy, but in the fight to improve science and keep all steps open, we made it public.
it combines data, primarily the infomration entered for each study
please see final data file for output as we did not make all orignial data available
but made the scirp tavaialable for learning
it checks most colums for entry error
it then does checks as follows
